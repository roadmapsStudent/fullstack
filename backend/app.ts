...
app.get("/api/posts/:id", (req, res) => {
  ...
  const author = findUserById(posts[postId].id).email.split("@")[0];
  let returnarray = posts[postId];
  Object.assign(returnarray, { authorname : author});
